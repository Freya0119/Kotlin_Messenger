    ...
    private fun listenLatestMessage() {
        ...
        latestMessageRef.addListenerForSingleValueEvent(object : ValueEventListener {
            ...
            override fun onDataChange(p0: DataSnapshot) {
                val userObj = p0.getValue(User::class.java)
                textView_latest_message_test.text = userObj?.username
                Picasso.get().load(userObj?.profileImageUrl).into(imageView_latest_message_test)
            }
        })
